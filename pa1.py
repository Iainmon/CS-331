...
#     if a==1: s=s+'a chicken'
#     elif a==2: s=s+'two chickens'
#     elif a==3: s=s+'a wolf'
#     elif a==4: s=s+'a wolf and a chicken'
#     elif a==5: s=s+'two wolves'

#     s=s+' to the '+('right' if p[i][0][2]==0 else 'left')+'\n'

#   return s+'Expanded '+str(pn[1])+' nodes.'
...
#     if _v not in explored:
#       if _v==g: return (p,n)
#       explored.add(_v)
#       neighbors=expand(_v,explored)
#       n=n+len(neighbors)
...
#   if lb: return move(e,lc,lw,rc,rw,1)
#   elif rb: return move(e,lc,lw,rc,rw,0)
#   else: return []




# def move(e,lc,lw,rc,rw,r):
#   l,n,x,y=-99,[],-99,-99

#   if r==1: l,x,y=0,1,2
#   else: l,x,y=1,-1,-2

#   if ok(e,lc  ,lw-y,l,rc  ,rw+y,r): n.append(((lc  ,lw-y,l),(rc  ,rw+y,r),5))
#   if ok(e,lc-x,lw-x,l,rc+x,rw+x,r): n.append(((lc-x,lw-x,l),(rc+x,rw+x,r),4))
#   if ok(e,lc  ,lw-x,l,rc  ,rw+x,r): n.append(((lc  ,lw-x,l),(rc  ,rw+x,r),3))
#   if ok(e,lc-y,lw  ,l,rc+y,rw  ,r): n.append(((lc-y,lw  ,l),(rc+y,rw  ,r),2))
#   if ok(e,lc-x,lw  ,l,rc+x,rw  ,r): n.append(((lc-x,lw  ,l),(rc+x,rw  ,r),1))
...
# def ok(e,lc,lw,l,rc,rw,r):
#   x=((lc,lw,l),(rc,rw,r)) not in e
#   y=(lc>=lw or lc==0) and (rc>=rw or rc==0)
#   z=lc in range(C) and lw in range(W) and rc in range(C) and rw in range(W)
